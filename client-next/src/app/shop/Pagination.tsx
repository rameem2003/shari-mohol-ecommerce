    ...
    <section className=" flex items-start justify-start my-2">
      {paginationData?.currentPage! > 1 && (
        <Link
          ...
          className="inline-block rounded-l-lg border-2 border-shari-mohol-primary p-4"
      ...
      <span className="inline-block border-2 border-shari-mohol-primary p-4 text-shari-mohol-primary font-semibold">
      ...
      {paginationData?.currentPage! < paginationData?.totalPages! && (
        <Link
          onClick={() => setOffset(paginationData?.currentPage! + 1)}
          className="inline-block rounded-r-lg border-2 border-shari-mohol-primary p-4"
          href={`?offset=${paginationData?.currentPage! + 1}`}
        >
