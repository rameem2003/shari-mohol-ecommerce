...
const Footer = () => {
  return (
    <footer className="tracking-wide bg-shari-mohol-primary px-8 sm:px-12 pt-12 pb-6">
      <Container>
        <div className="grid min-[1200px]:grid-cols-3 gap-12 xl:gap-16">
          <div className="min-[1200px]:max-w-sm max-w-lg w-full">
            <a href="https://rolstudiobangladesh.vercel.app/" target="_blank">
              <img
                src="https://rolstudiobangladesh.vercel.app/_next/image?url=%2Flogo.png&w=256&q=75"
                alt="logo"
                className="w-60"
              />
            </a>
            <div className="mt-6">
              <p className="text-white leading-relaxed text-sm">
                We provide personalized services to help you thrive in the
                digital world, offering expert guidance tailored to your unique
                business goals and driving growth and innovation
              </p>
            </div>
              ...
              <ul className="mt-6 space-y-4">
                <li>
                  <a
                    ...
                    className="hover:text-white text-white text-sm font-normal"
                  >
                    Web Development
                  </a>
                </li>
        ...
        <div className="flex flex-wrap max-md:flex-col gap-4">
          ...
          <p className="text-white text-sm md:ml-auto">
            © Shari Mohol. Made by ROL Studio Bangladesh. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
