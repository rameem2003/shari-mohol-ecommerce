          ...
          <div className="slider-container mb-4 w-full flex-nowrap relative overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
            <div className="marqueeSliderLeft flex items-center gap-5 ">
              <p className=" whitespace-nowrap text-white font-medium">
                ...
                maiores nam quisquam accusantium non, itaque placeat corporis in
                esse aut ipsa facilis modi asperiores, molestias natus, nulla
                eius blanditiis harum. Vero, delectus! Laudantium illum
                consequuntur odio nisi, nemo culpa eos debitis ipsam minus quod
                distinctio sit iure consectetur corrupti. Nesciunt distinctio
                nulla optio error velit totam impedit eaque cum quibusdam
                laboriosam blanditiis quos sed ullam illo et nobis ratione,
                voluptatum doloremque debitis corporis necessitatibus. Beatae,
                ullam.
              </p>
            </div>
          </div>
